...
conservative_filter_ui::conservative_filter_ui(QWidget * pParent):QDialog(pParent)
{
	setWindowTitle("Conservative Filter");
	RadiusValue = 3;
...
void conservative_filter_ui::setRadiusValue(double t)
{
	RadiusValue = t;
}

double conservative_filter_ui::getRadiusValue()
{
	return RadiusValue;
}